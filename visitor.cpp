...
Value * SomeVisitor::visit(class Program* node) {
...
Value * SomeVisitor::visit(class BinaryOpExpression* node) {
...
Value * SomeVisitor::visit(class UnaryOpExpression* node) {
...
Value * SomeVisitor::visit(class MethodCall* node) {
	cout << "Method call: ";
...
Value * SomeVisitor::visit(class MethodArgInpList* node) {
	int num = 1;
...
Value * SomeVisitor::visit(class CalloutCall* node) {
	cout << "Callout Call: ";
...
Value * SomeVisitor::visit(class CalloutArgList* node) {
	int num = 1;
	for (auto arg: node->arg_list) {
		cout << "Arg #" << num << ": ";
		arg->accept(this);
...
Value * SomeVisitor::visit(class TerminalVariable* node) {
	cout << *(node->variable_name);
	return nullptr;
}

Value * SomeVisitor::visit(class ArrayTerminalVariable* node) {
...
Value * SomeVisitor::visit(class FieldDeclList* node) {
	int decl_num = 1;
...
Value * SomeVisitor::visit(class VariableList* node) {
...
Value * SomeVisitor::visit(class MethodDeclList* node) {
...
Function * SomeVisitor::visit(class MethodDecl* node) {	
	cout << "Method name: ";
...
Value * SomeVisitor::visit(class ParamList* node) {
...
Value * SomeVisitor::visit(class Block* node) {
	node->decleration_list->accept(this);
	return nullptr;
	node->statement_list->accept(this);
}
Value * SomeVisitor::visit(class StatementList* node) {
	int statement_num = 1;
...
Value * SomeVisitor::visit(class AssignStmt* node) {
...
Value * SomeVisitor::visit(class IfElseStmt* node) {
...
Value * SomeVisitor::visit(class IfStmt* node) {
...
Value * SomeVisitor::visit(class ForStmt* node) {
	cout << "For statement: ";
...
Value * SomeVisitor::visit(class RetExpr* node) {
	cout << "Return statement: ";
	cout << "expression: "; node->expr->accept(this); cout << endl;
	return nullptr;
}

Value * SomeVisitor::visit(class StringRetBrkContStatement* node) {
	cout << *(node->type) << " statement" << endl;
	return nullptr;
}

Value * SomeVisitor::visit(class Location* node) {
	cout << "Location: ";
...
Value * SomeVisitor::visit(class CalloutArg* node) {
...
Value * SomeVisitor::visit(class Literal* node) {
	cout << "Literal: ";
